    ...
    <>
      ...
      {token && (
        <div className="w-full h-screen flex flex-row">
          ...
          {/* PROVIDER */}
          <div className="xl:w-[80vw] w-full flex flex-col grow">
            <Topbar setSidebar={setSidebar} user={user} />
            <main className="w-full max-h-[90vh] overflow-auto flex flex-col gap-6 xl:px-20 px-5 py-10">
              ...
              <div className="w-full flex flex-row justify-between">
                <input
                  ...
                  className="border basis-full xl:basis-1/4 px-4 py-3 rounded-lg"
                />
              ...
              <Table data={data} pending={pending} query={query} />
            </main>
          </div>
        </div>
      )}
